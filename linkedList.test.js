...
// convention to put the # pound sign in front to indicate that its a method
describe('#insertAtHead', () => {
  test('it adds the element to the beginning of the list', () => {
    const ll = new LinkedList()
    ll.insertAtHead(10)
    const oldHead = ll.head // reference to the firstElement
    // ..then overwriting the oldHead with a new head value
    ll.insertAtHead(20)
...
describe('#insertAtIndex', () => {
  ...
  describe('with index in the middle', () => {
    test('insert element at the given index', () => {
      const ll = LinkedList.fromValues(10, 20, 30, 40)
...
describe('#removeAtIndex', () => {
  describe('with index less than zero', () => {
    ...
    describe('with index in the middle', () => {
      test('remove element at the given index', () => {
        const ll = LinkedList.fromValues(10, 20, 30, 40)
        ll.removeAtIndex(2)
